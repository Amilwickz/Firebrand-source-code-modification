...
INTEGER                              :: LU_FBRND ! by MR
CHARACTER(80)                        :: FN_FBRND !by MR
REAL(EB)                             :: PREV_TIME=0.0_EB !by MR
...
INTEGER :: N_FBRAND_GEN_PKG_ML=432 !< Added by MR - ember/firebrand generation for kg of mass loss
INTEGER :: N_FBRAND_GEN_TOT_ML=0   !< Added by MR - ember/firebrand generation total mass loss
